...
class CobbleStoneSpawn : Listener {
    ...
    fun breakStone(event : BlockBreakEvent) {
        ...
        if(breakTool.type != Material.WOODEN_PICKAXE && breakTool.type != Material.STONE_PICKAXE && breakTool.type != Material.IRON_PICKAXE && breakTool.type != Material.DIAMOND_PICKAXE && breakTool.type != Material.NETHERITE_PICKAXE) return
